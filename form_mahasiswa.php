...
echo "<body>";
echo "<font color='brown' face='Arial' size=5><b><br>Data Mahasiswa</b></font><br><b
r>";
...
\"green\" bgcolor=\"white\">
<tr bgcolor='green' height=\"50\"><font color='white'>
...
<th align='center'><font color='white' face='Arial' size=3>Tempat Lahir</font>
</th>
<th align='center'><font color='white' face='Arial' size=3>Tanggal Lahir</font
></th>
<th align='center'><font color='white' face='Arial' size=3>Jenis Kelamin</font
></th>
...
<th align='center'><font color='white' face='Arial' size=3>Aksi</font></th>

</tr>";
$j=0;
while ($row=mysqli_fetch_array($query)) {
echo "<tr><td align='center' bgcolor='#50abf5'>";
echo "<font face='Arial' size=2>";
echo $j+1;
echo "</font>";
echo "</td>";
echo "<td align='left=' bgcolor='#50abf5'>";
echo "<font face='Arial' size=2>";
echo $row["NPM"];
echo"</font>";
echo"</td>";
